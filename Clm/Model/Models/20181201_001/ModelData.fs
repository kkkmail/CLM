...
module ModelData = 
    ...
    let d1 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            ...
            0.001 * x.[17] // bA | ligation: b + A <-> bA
            -0.0001 * x.[4] * x.[1] // b + A | ligation: b + A <-> bA
            0.001 * x.[36] // Abb | ligation: A + bb <-> Abb
            -0.0001 * x.[1] * x.[20] // A + bb | ligation: A + bb <-> Abb
            0.001 * x.[35] // Aba | ligation: A + ba <-> Aba
            -0.0001 * x.[1] * x.[19] // A + ba | ligation: A + ba <-> Aba
            0.001 * x.[34] // AbB | ligation: A + bB <-> AbB
            -0.0001 * x.[1] * x.[18] // A + bB | ligation: A + bB <-> AbB
            0.001 * x.[33] // AbA | ligation: A + bA <-> AbA
            -0.0001 * x.[1] * x.[17] // A + bA | ligation: A + bA <-> AbA
            0.001 * x.[32] // Aab | ligation: A + ab <-> Aab
            -0.0001 * x.[1] * x.[16] // A + ab | ligation: A + ab <-> Aab
            0.001 * x.[31] // Aaa | ligation: A + aa <-> Aaa
            -0.0001 * x.[1] * x.[15] // A + aa | ligation: A + aa <-> Aaa
            0.001 * x.[30] // AaB | ligation: A + aB <-> AaB
            -0.0001 * x.[1] * x.[14] // A + aB | ligation: A + aB <-> AaB
            0.001 * x.[29] // AaA | ligation: A + aA <-> AaA
            -0.0001 * x.[1] * x.[13] // A + aA | ligation: A + aA <-> AaA
            0.001 * x.[28] // ABb | ligation: A + Bb <-> ABb
            -0.0001 * x.[1] * x.[12] // A + Bb | ligation: A + Bb <-> ABb
            0.001 * x.[27] // ABa | ligation: A + Ba <-> ABa
            -0.0001 * x.[1] * x.[11] // A + Ba | ligation: A + Ba <-> ABa
            0.001 * x.[26] // ABB | ligation: A + BB <-> ABB
            -0.0001 * x.[1] * x.[10] // A + BB | ligation: A + BB <-> ABB
            0.001 * x.[25] // ABA | ligation: A + BA <-> ABA
            -0.0001 * x.[1] * x.[9] // A + BA | ligation: A + BA <-> ABA
            0.001 * x.[24] // AAb | ligation: A + Ab <-> AAb
            -0.0001 * x.[1] * x.[8] // A + Ab | ligation: A + Ab <-> AAb
            0.001 * x.[23] // AAa | ligation: A + Aa <-> AAa
            -0.0001 * x.[1] * x.[7] // A + Aa | ligation: A + Aa <-> AAa
            0.001 * x.[22] // AAB | ligation: A + AB <-> AAB
            -0.0001 * x.[1] * x.[6] // A + AB | ligation: A + AB <-> AAB
            0.001 * x.[21] // AAA | ligation: A + AA <-> AAA
            -0.0001 * x.[1] * x.[5] // A + AA | ligation: A + AA <-> AAA
            0.001 * x.[8] // Ab | ligation: A + b <-> Ab
            -0.0001 * x.[1] * x.[4] // A + b | ligation: A + b <-> Ab
            0.001 * x.[13] // aA | ligation: a + A <-> aA
            -0.0001 * x.[3] * x.[1] // a + A | ligation: a + A <-> aA
            0.001 * x.[7] // Aa | ligation: A + a <-> Aa
            -0.0001 * x.[1] * x.[3] // A + a | ligation: A + a <-> Aa
            0.001 * x.[6] // AB | ligation: A + B <-> AB
            -0.0001 * x.[1] * x.[2] // A + B | ligation: A + B <-> AB
            0.001 * x.[5] // AA | ligation: A + A <-> AA
            0.001 * x.[5] // AA | ligation: A + A <-> AA
            -0.0001 * x.[1] * x.[1] // A + A | ligation: A + A <-> AA
            -0.0001 * x.[1] * x.[1] // A + A | ligation: A + A <-> AA
            -0.001 * x.[1] // A | synthesis: Y <-> A
            0.0001 * x.[0] // Y | synthesis: Y <-> A
        |]
    ...
    let d2 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            ...
            0.001 * x.[52] // Bbb | ligation: B + bb <-> Bbb
            -0.0001 * x.[2] * x.[20] // B + bb | ligation: B + bb <-> Bbb
            0.001 * x.[51] // Bba | ligation: B + ba <-> Bba
            -0.0001 * x.[2] * x.[19] // B + ba | ligation: B + ba <-> Bba
            0.001 * x.[50] // BbB | ligation: B + bB <-> BbB
            -0.0001 * x.[2] * x.[18] // B + bB | ligation: B + bB <-> BbB
            0.001 * x.[49] // BbA | ligation: B + bA <-> BbA
            -0.0001 * x.[2] * x.[17] // B + bA | ligation: B + bA <-> BbA
            0.001 * x.[48] // Bab | ligation: B + ab <-> Bab
            -0.0001 * x.[2] * x.[16] // B + ab | ligation: B + ab <-> Bab
            0.001 * x.[47] // Baa | ligation: B + aa <-> Baa
            -0.0001 * x.[2] * x.[15] // B + aa | ligation: B + aa <-> Baa
            0.001 * x.[46] // BaB | ligation: B + aB <-> BaB
            -0.0001 * x.[2] * x.[14] // B + aB | ligation: B + aB <-> BaB
            0.001 * x.[45] // BaA | ligation: B + aA <-> BaA
            -0.0001 * x.[2] * x.[13] // B + aA | ligation: B + aA <-> BaA
            0.001 * x.[44] // BBb | ligation: B + Bb <-> BBb
            -0.0001 * x.[2] * x.[12] // B + Bb | ligation: B + Bb <-> BBb
            0.001 * x.[43] // BBa | ligation: B + Ba <-> BBa
            -0.0001 * x.[2] * x.[11] // B + Ba | ligation: B + Ba <-> BBa
            0.001 * x.[42] // BBB | ligation: B + BB <-> BBB
            -0.0001 * x.[2] * x.[10] // B + BB | ligation: B + BB <-> BBB
            0.001 * x.[41] // BBA | ligation: B + BA <-> BBA
            -0.0001 * x.[2] * x.[9] // B + BA | ligation: B + BA <-> BBA
            0.001 * x.[40] // BAb | ligation: B + Ab <-> BAb
            -0.0001 * x.[2] * x.[8] // B + Ab | ligation: B + Ab <-> BAb
            0.001 * x.[39] // BAa | ligation: B + Aa <-> BAa
            -0.0001 * x.[2] * x.[7] // B + Aa | ligation: B + Aa <-> BAa
            0.001 * x.[38] // BAB | ligation: B + AB <-> BAB
            -0.0001 * x.[2] * x.[6] // B + AB | ligation: B + AB <-> BAB
            0.001 * x.[37] // BAA | ligation: B + AA <-> BAA
            -0.0001 * x.[2] * x.[5] // B + AA | ligation: B + AA <-> BAA
            0.001 * x.[18] // bB | ligation: b + B <-> bB
            -0.0001 * x.[4] * x.[2] // b + B | ligation: b + B <-> bB
            0.001 * x.[12] // Bb | ligation: B + b <-> Bb
            -0.0001 * x.[2] * x.[4] // B + b | ligation: B + b <-> Bb
            0.001 * x.[11] // Ba | ligation: B + a <-> Ba
            -0.0001 * x.[2] * x.[3] // B + a | ligation: B + a <-> Ba
            0.001 * x.[10] // BB | ligation: B + B <-> BB
            0.001 * x.[10] // BB | ligation: B + B <-> BB
            -0.0001 * x.[2] * x.[2] // B + B | ligation: B + B <-> BB
            -0.0001 * x.[2] * x.[2] // B + B | ligation: B + B <-> BB
            0.001 * x.[14] // aB | ligation: a + B <-> aB
            -0.0001 * x.[3] * x.[2] // a + B | ligation: a + B <-> aB
            0.001 * x.[6] // AB | ligation: A + B <-> AB
            -0.0001 * x.[1] * x.[2] // A + B | ligation: A + B <-> AB
            -0.001 * x.[2] // B | synthesis: Y <-> B
            0.0001 * x.[0] // Y | synthesis: Y <-> B
    ...
    let d3 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            ...
            0.001 * x.[11] // Ba | ligation: B + a <-> Ba
            -0.0001 * x.[2] * x.[3] // B + a | ligation: B + a <-> Ba
            0.001 * x.[58] // aBB | ligation: a + BB <-> aBB
            -0.0001 * x.[3] * x.[10] // a + BB | ligation: a + BB <-> aBB
            0.001 * x.[57] // aBA | ligation: a + BA <-> aBA
            -0.0001 * x.[3] * x.[9] // a + BA | ligation: a + BA <-> aBA
            0.001 * x.[60] // aBb | ligation: a + Bb <-> aBb
            -0.0001 * x.[3] * x.[12] // a + Bb | ligation: a + Bb <-> aBb
            0.001 * x.[59] // aBa | ligation: a + Ba <-> aBa
            -0.0001 * x.[3] * x.[11] // a + Ba | ligation: a + Ba <-> aBa
            0.001 * x.[54] // aAB | ligation: a + AB <-> aAB
            -0.0001 * x.[3] * x.[6] // a + AB | ligation: a + AB <-> aAB
            0.001 * x.[53] // aAA | ligation: a + AA <-> aAA
            -0.0001 * x.[3] * x.[5] // a + AA | ligation: a + AA <-> aAA
            0.001 * x.[56] // aAb | ligation: a + Ab <-> aAb
            -0.0001 * x.[3] * x.[8] // a + Ab | ligation: a + Ab <-> aAb
            0.001 * x.[55] // aAa | ligation: a + Aa <-> aAa
            -0.0001 * x.[3] * x.[7] // a + Aa | ligation: a + Aa <-> aAa
            0.001 * x.[66] // abB | ligation: a + bB <-> abB
            -0.0001 * x.[3] * x.[18] // a + bB | ligation: a + bB <-> abB
            0.001 * x.[65] // abA | ligation: a + bA <-> abA
            -0.0001 * x.[3] * x.[17] // a + bA | ligation: a + bA <-> abA
            0.001 * x.[68] // abb | ligation: a + bb <-> abb
            -0.0001 * x.[3] * x.[20] // a + bb | ligation: a + bb <-> abb
            0.001 * x.[67] // aba | ligation: a + ba <-> aba
            -0.0001 * x.[3] * x.[19] // a + ba | ligation: a + ba <-> aba
            0.001 * x.[62] // aaB | ligation: a + aB <-> aaB
            -0.0001 * x.[3] * x.[14] // a + aB | ligation: a + aB <-> aaB
            0.001 * x.[61] // aaA | ligation: a + aA <-> aaA
            -0.0001 * x.[3] * x.[13] // a + aA | ligation: a + aA <-> aaA
            0.001 * x.[64] // aab | ligation: a + ab <-> aab
            -0.0001 * x.[3] * x.[16] // a + ab | ligation: a + ab <-> aab
            0.001 * x.[63] // aaa | ligation: a + aa <-> aaa
            -0.0001 * x.[3] * x.[15] // a + aa | ligation: a + aa <-> aaa
            0.001 * x.[14] // aB | ligation: a + B <-> aB
            -0.0001 * x.[3] * x.[2] // a + B | ligation: a + B <-> aB
            0.001 * x.[13] // aA | ligation: a + A <-> aA
            -0.0001 * x.[3] * x.[1] // a + A | ligation: a + A <-> aA
            0.001 * x.[7] // Aa | ligation: A + a <-> Aa
            -0.0001 * x.[1] * x.[3] // A + a | ligation: A + a <-> Aa
            0.001 * x.[16] // ab | ligation: a + b <-> ab
            -0.0001 * x.[3] * x.[4] // a + b | ligation: a + b <-> ab
            0.001 * x.[15] // aa | ligation: a + a <-> aa
            0.001 * x.[15] // aa | ligation: a + a <-> aa
            -0.0001 * x.[3] * x.[3] // a + a | ligation: a + a <-> aa
            -0.0001 * x.[3] * x.[3] // a + a | ligation: a + a <-> aa
            -0.001 * x.[3] // a | synthesis: Y <-> a
            0.0001 * x.[0] // Y | synthesis: Y <-> a
        |]
    ...
    let d4 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            ...
            0.001 * x.[74] // bBB | ligation: b + BB <-> bBB
            -0.0001 * x.[4] * x.[10] // b + BB | ligation: b + BB <-> bBB
            0.001 * x.[73] // bBA | ligation: b + BA <-> bBA
            -0.0001 * x.[4] * x.[9] // b + BA | ligation: b + BA <-> bBA
            0.001 * x.[76] // bBb | ligation: b + Bb <-> bBb
            -0.0001 * x.[4] * x.[12] // b + Bb | ligation: b + Bb <-> bBb
            0.001 * x.[75] // bBa | ligation: b + Ba <-> bBa
            -0.0001 * x.[4] * x.[11] // b + Ba | ligation: b + Ba <-> bBa
            0.001 * x.[70] // bAB | ligation: b + AB <-> bAB
            -0.0001 * x.[4] * x.[6] // b + AB | ligation: b + AB <-> bAB
            0.001 * x.[69] // bAA | ligation: b + AA <-> bAA
            -0.0001 * x.[4] * x.[5] // b + AA | ligation: b + AA <-> bAA
            0.001 * x.[72] // bAb | ligation: b + Ab <-> bAb
            -0.0001 * x.[4] * x.[8] // b + Ab | ligation: b + Ab <-> bAb
            0.001 * x.[71] // bAa | ligation: b + Aa <-> bAa
            -0.0001 * x.[4] * x.[7] // b + Aa | ligation: b + Aa <-> bAa
            0.001 * x.[82] // bbB | ligation: b + bB <-> bbB
            -0.0001 * x.[4] * x.[18] // b + bB | ligation: b + bB <-> bbB
            0.001 * x.[81] // bbA | ligation: b + bA <-> bbA
            -0.0001 * x.[4] * x.[17] // b + bA | ligation: b + bA <-> bbA
            0.001 * x.[84] // bbb | ligation: b + bb <-> bbb
            -0.0001 * x.[4] * x.[20] // b + bb | ligation: b + bb <-> bbb
            0.001 * x.[83] // bba | ligation: b + ba <-> bba
            -0.0001 * x.[4] * x.[19] // b + ba | ligation: b + ba <-> bba
            0.001 * x.[78] // baB | ligation: b + aB <-> baB
            -0.0001 * x.[4] * x.[14] // b + aB | ligation: b + aB <-> baB
            0.001 * x.[77] // baA | ligation: b + aA <-> baA
            -0.0001 * x.[4] * x.[13] // b + aA | ligation: b + aA <-> baA
            0.001 * x.[80] // bab | ligation: b + ab <-> bab
            -0.0001 * x.[4] * x.[16] // b + ab | ligation: b + ab <-> bab
            0.001 * x.[79] // baa | ligation: b + aa <-> baa
            -0.0001 * x.[4] * x.[15] // b + aa | ligation: b + aa <-> baa
            0.001 * x.[18] // bB | ligation: b + B <-> bB
            -0.0001 * x.[4] * x.[2] // b + B | ligation: b + B <-> bB
            0.001 * x.[12] // Bb | ligation: B + b <-> Bb
            -0.0001 * x.[2] * x.[4] // B + b | ligation: B + b <-> Bb
            0.001 * x.[17] // bA | ligation: b + A <-> bA
            -0.0001 * x.[4] * x.[1] // b + A | ligation: b + A <-> bA
            0.001 * x.[20] // bb | ligation: b + b <-> bb
            0.001 * x.[20] // bb | ligation: b + b <-> bb
            -0.0001 * x.[4] * x.[4] // b + b | ligation: b + b <-> bb
            -0.0001 * x.[4] * x.[4] // b + b | ligation: b + b <-> bb
            0.001 * x.[8] // Ab | ligation: A + b <-> Ab
            -0.0001 * x.[1] * x.[4] // A + b | ligation: A + b <-> Ab
            0.001 * x.[16] // ab | ligation: a + b <-> ab
