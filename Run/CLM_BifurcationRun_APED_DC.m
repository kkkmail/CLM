...
(* ============================================== *)
InitPairFormValue=True;
InitCrystValue=True;
InitCrystDecValue=True;
InitBasicCrystValue=True;
InitChainCrystValue=False;
(* ============================================== *)
UseSigmaFixed=False;
UseRho0Fixed=False;
UseLogScale=False;
...
LigationEnantSel=EnantSelAll;
InvLigationEnantSel=EnantSelAll;
(* ============================================== *)
(* ============================================== *)
(* Epimerization *)
