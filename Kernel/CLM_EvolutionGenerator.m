...
(* :Version: Revision: 3.24.001, Date: 2016/05/29 *)
...
(* ============================================== *)
(* ============================================== *)
EvolutionGeneratorVersion="3.24.001";
(* ============================================== *)
EvRunTypeNone=0;
EvRunTypeAll=1;
EvRunTypeList=2;
...
(* ==============================================*)
EvolutionRun[catIdx_?IntegerQ,sedPairIdx_?IntegerQ,useMinusOne$sigmaVal_?BooleanQ,tMaxVal_?NumericQ]:=Module[{options,useNNT,name1\:02d6,name2\:02d6,crystName\:02d6\:02d6,name1\:02d7,name2\:02d7,crystName\:02d6\:02d7,rMax\:02d6\:02d6,kCryst\:02d6\:02d6,kDiss\:02d6\:02d6,rMax\:02d6\:02d7,kCryst\:02d6\:02d7,kDiss\:02d6\:02d7,substId,subst1Id,substLen,base,base1,substDecayName,crystDecay\:02d6\:02d6,crystDecay\:02d6\:02d7,initialValuesOptions,outputOptions,runChainModelOptions,plotSubstanceOptions,description,sol,nuLst,nuLstSorted,aaTotalLst,aaTotal,aaBothEnantNormLst,aaBothEnantNormLstSorted,nuTotalLst,nuTotalLstSorted,aaBothEnantNormTotalLstSorted,nameCoeff,name1Coeff,nameCoeffEnant,name1CoeffEnant,reacCoeffName,reacCoeffNameEnant,retVal,NDSolveMonitorOptions,subst1Id1DisplVal,reacCoeff$A$EA$Name, reacCoeff$EA$A$Name, cryst$A$A$Name, cryst$EA$EA$Name, cryst$A$EA$Name, cryst$EA$A$Name,maxChainLen,useActivation,nameCoeff$E$A,nameCoeff$E$B,reacCoeff$A$A$Name,reacCoeff$EA$EA$Name,substIdVal,subst1Id1Val,len,strCryst,rLst},
(* ============================================== *)
