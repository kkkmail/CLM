...
(* ============================================== *)
(* ============================================== *)
CLMVersionMain="3.23.001";
CLMReleaseDateMain="2016/01/13";
CLMCopyrightStr="Copyright: K^3, 2013 - 2016.";
...
ClmWorkingPrecision - precision of the calculation, which is used only if high precision is used, - TODO - describe and implement,
...
MonitorTypeData=2;
(* ============================================== *)
Options[CLMS]={ClmWorkingPrecision-> 35,UseHighPrecision -> True,LRInitialAmount-> 10^-6,ForceZeroLRInitialAmount -> False, UseCoeffTransform -> True, UseZSubstanceForRo0 -> False,DoNotOutputZeroCoefficients -> True, NoOfPlotPoints -> 51, yMultDefault -> 1, PlotFast -> False,DoNotOutputWeakModels -> True, WeakNuValue -> 10^-3,SilentWeakModels -> True,UsePrerequisites -> False, UseVariableRacemizationForAll -> True,OutputAllModelNames -> False,UseZeroAEquation -> False,MultStoNS -> 1,MultBsstoBlr -> 1,MultBlrtoBss -> 1,MultCsstoClr -> 1,MultClrtoCss -> 1,UseGamma -> False, UseGammaPlus -> False, UseGammaMinus -> False,Print\[Rho]AllFuncInfo -> False,Print\[Rho]AllFuncInfoTrigger -> True,\[Rho]AllFuncDescription -> "",NDSolveMaxSteps -> Infinity,NDSolveStepSize -> None (*10^-4*),NDSolveMethod -> {"FixedStep",Method->{"ExplicitRungeKutta","DifferenceOrder"->5,"StiffnessTest"->False}},NDSolveAccuracyGoal -> None,NDSolvePrecisionGoal -> None,NDSolveWorkingPrecision -> None,NDSolveUseDerivativeForAggregateSubst -> False,NDSolveUseFuncForAggregateSubst -> True,NDSolveUseNumericFuncForAggregateSubst -> True,ModelDescriptorValue -> Undefined, RotateXY -> False, SwapXY -> False (* does not work in full yet *),UseBWLightingInPlot3D -> False, DoNotOutput3D -> False,ApplyCoeffRule -> True,PrintPrepareEquationsInfo -> False,DoNotUseInterpolationFunction-> False,MonitorType->None,UseShowProgress->True,StepMonitorFunction -> None,EvaluationMonitorFunction -> None,UseOneMonitor-> True,PrintMonitorData-> False,MonitorPrintFrequency -> 1,MonitorPrintAllFirst -> 20,NStorage-> 1000,NStorageMultiplier-> 10,RoTotalNorm->1,MonitorPlotFunction -> None,DynamicStepMonitor -> None,QuitMonitor->None,UseAllSubstForCryst -> True,AllSubstForCrystType -> AllSubstForCrystVolumeAllocation,AllSubstForCrystAlpha-> (1/2),UseWhenEvent -> False,UseAnalyticNonNegatieX -> True,NonNegativeType -> NonNegativeTypeAnalytic};
(* ============================================== *)
NStorageValue=0;
StepMonitorArray={};
